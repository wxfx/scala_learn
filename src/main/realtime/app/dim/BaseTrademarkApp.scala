...
import bean.dim.{BaseCategory3, BaseTrademark}
...
object BaseTrademarkApp{
  def main(args: Array[String]): Unit = {
    ...
    val objectDstream: DStream[BaseTrademark] = inputGetOffsetDstream.map { record =>
      ...
      val obj: BaseCategory3 = JSON.parseObject(jsonStr, classOf[BaseTrademark])
      obj
    }

    objectDstream.foreachRDD{rdd=>
      import org.apache.phoenix.spark._
      rdd.saveToPhoenix("GMALL1122_BASE_TRADEMARK", Seq("ID", "TM_NAME", "REGION_ID", "AREA_CODE"),
