...
import bean.dim.{BaseCategory3, BaseProvince}
...
object BaseProvinceApp{
  def main(args: Array[String]): Unit = {
    ...
    val objectDstream: DStream[BaseProvince] = inputGetOffsetDstream.map { record =>
      val jsonStr: String = record.value()
      val obj: BaseCategory3 = JSON.parseObject(jsonStr, classOf[BaseProvince])
      obj
    }
